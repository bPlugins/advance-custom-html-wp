...
const dashboardInfo = info => {
  ...
  return {
    ...
    changelogs: [{
      ...
      type: 'new',
      list: ["New: Reorganized block settings with custom panel iconography.", "Update: Unlocked Word Wrap, Line Numbers, Title Bar, and Copy Button for free users.", "Update: Unlocked HTML, CSS, JavaScript syntaxes and basic editor color themes.", "Fix: Resolved icon layout and coloring style alignment conflicts in block sidebar."]
    }, {
    ...
    proFeatures: ["40+ editor themes", "Tab size, line wrapping, editor height / width", "Syntax mode per snippet: HTML, CSS, JS, PHP, Python, and more", "Copy button, Fold gutter, Highlight active line, etc", "Customize the Copy to Clipboard button", "Hide Headings or Labels", "Hide or Show Line numbers", "Enable or Disable Wrap", "Customize Code Editor / Snippet", "Fold Gutter to collapse code blocks", "Highlight Active Line"]
    // startButton: {
    //   label: 'Start Now',
...
const demoInfo = {
  ...
  demos: [{
    ...
    description: "Code snippets wit copy button text in Bottom Right position (Pro)",
    type: "iframe",
...
document.addEventListener('DOMContentLoaded', () => {
  const dashboardEl = document.getElementById('bplAdminHelpPageWrapper');
